...
import { CartItem, useFoodContext } from "../context";
import { CartViewModel } from "../viewmodels";
import { useNavigate } from "../hooks/useNavigate";
import { pattersValues } from "../helpers/pattersValues";
import { colors } from "../colors";

export const CartView = () => {
    const { cart, removeCart, incrementQuantity, decrementQuantity, quantidadeCart } = useFoodContext();
    const { delivery, tax, setSubtotal, setTotal, subtotal, total } = CartViewModel();
        ...
        <View style={styles.container}>
            ...
            <View style={styles.viewBtn}>
                <TouchableOpacity
                    ...
                    onPress={checkout}
                >
                    <Text style={styles.btnTxt}>Finish Order</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
